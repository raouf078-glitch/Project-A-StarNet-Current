/**
 * Whacka client SDK — _host-bridge (stub)
 *
...
export const shouldUseHostBridge = __wk('shouldUseHostBridge');
export const sendHostRequest = __wk('sendHostRequest');
export const installHostBridge = __wk('installHostBridge');
